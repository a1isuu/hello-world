...
def cadastro():
    ...
    while (resposta != 'Y') or (resposta != 'y'):
        ...
        if idade < 18:
            print(
                'Não é possível prosseguir com o cadastro. Idade informada é menor que 18 anos.')
            exit()
        elif idade > 99:
            print(
                'Não é possível prosseguir com o cadastro. Idade informada é aposentada.')
            exit()
        else:
    ...
    sexo = str(input(
        'Selecione a opção que indique seu gênero:\n1 - Masculino\n2 - Feminino\n3 - Prefiro não informar\n4 - Outros\n'))
    ...
    while (resposta != 'Y') or (resposta != 'y'):
        ...
        resposta = input(cpf[:3]+'.'+cpf[3:6]+'.'+cpf[6:9]+'-' +
                         cpf[9:]+' esta correto?\nY - Para sim, N - Para não.\n')
        if (resposta == 'Y') or (resposta == 'y'):
            break
    ...
    while (resposta != 'Y') or (resposta != 'y'):
        ...
        telefone = input('Insira seu número de telefone (DDD e número):\n')
        ddd = str(telefone[:3])
